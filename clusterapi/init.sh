...
export NODE_VM_IMAGE_TEMPLATE="harbor.crownlabs.polito.it/capk/ubuntu-2004-container-disk:v1.28.5"
...
function createcluster () {
    ...
    name="cluster-${index}-${cni}-${podcidrtype}-ubuntu"
...
function liqoinstall (){
    ...
    version=484c748fe8d3dc3982bccf4b64f44d57958f4a7c
